        ...
        document.onkeyup = function () {
            ...
            if (word.indexOf(userGuess) < 0) {
                ...
                if (strikes == 0) {
                    ...
                    instructions_span.innerHTML = ('<input id="resetButton" type="button" value="YOU LOSE! CLICK TO PLAY AGAIN!" onclick="reset();" />');
                    laugh_audio.play();
                ...
                for (i = 0; i < word.length; i++) {
                    ...
                    if (word[i] === userGuess) {
                        ...
                        if (secret.indexOf("_ ") == -1) {
                            wins++;
                            wins_p.innerHTML = wins;
                            instructions_span.innerHTML = ('<input id="resetButton" type="button" value="YOU GOT IT! CLICK TO PLAY AGAIN!" onclick="reset();" />');
                            haunting_audio.play();
